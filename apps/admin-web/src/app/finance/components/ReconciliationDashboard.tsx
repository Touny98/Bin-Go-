        ...
        <div className="space-y-4">
          <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-700">
            <div className="flex items-center justify-between mb-2">
              <span className="text-[10px] font-bold text-gray-500 uppercase">Tasa de éxito</span>
          ...
          <div className="flex items-center justify-between p-3 border-b border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium">Diferencias detectadas</span>
            </div>
          ...
          <div className="flex items-center justify-between p-3 border-b border-gray-100 dark:border-gray-700">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium">Transacciones huérfanas</span>
            </div>
            <span className="text-xs font-bold text-yellow-600">7</span>
          </div>
          
          <div className="pt-4">
            <p className="text-[10px] text-gray-400 font-bold mb-2 uppercase">Incidente reciente</p>
            <p className="text-[10px] text-gray-600 dark:text-gray-400">"ID: tx_882 diferencia en confirmación del proveedor. Resuelto por el sistema."</p>
          </div>
        </div>
      </div>
    </div>
